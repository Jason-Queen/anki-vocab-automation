...
class AudioManager:
    ...
    def __init__(self, temp_dir: Optional[str] = None):
        ...
        self.session.headers.update({"User-Agent": "Anki-Vocabulary-Automation/2.0 (Audio Download)"})
    ...
    def _is_valid_audio_content_type(self, content_type: str) -> bool:
        ...
        audio_types = ["audio/", "application/octet-stream", "binary/octet-stream"]  # 通用二进制类型
    ...
    def get_audio_info(self, file_path: str) -> Optional[dict]:
        ...
        try:
            ...
            stat = path.stat()
            return {"filename": path.name, "size": stat.st_size, "modified": stat.st_mtime, "exists": True}
