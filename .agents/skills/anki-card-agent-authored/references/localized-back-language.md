...
6. 如果要把背面标签也改掉：
   ...
   - 再用 `.agents/skills/anki-card-agent-authored/scripts/localize_back_template.py` 按标签映射更新该模型的 `Card 1` 背面模板；
...
```bash
python3 .agents/skills/anki-card-agent-authored/scripts/localize_back_template.py \
