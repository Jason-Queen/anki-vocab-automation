...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python3 .agents/skills/anki-card-agent-authored/scripts/ankiconnect_request.py --action findNotes "
            "--params-json '{\"query\":\"deck:\\\"Vocabulary_LocalSmoke\\\"\"}' --pretty\n"
            "  printf '{\"scopes\":[\"actions\"],\"actions\":null}' | "
            "python3 .agents/skills/anki-card-agent-authored/scripts/ankiconnect_request.py --action apiReflect --params-stdin --pretty"
        ),
